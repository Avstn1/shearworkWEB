  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-[var(--navbar)]/90 backdrop-blur-md shadow-sm">
      <div className="w-full px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center relative">
        ...
        <Link
          href="/"
          className="text-[clamp(1.25rem,4vw,2rem)] font-bold text-[var(--highlight)]"
        >
          ✂️ ShearWork
        </Link>
        ...
        <div className="flex items-center gap-2 sm:gap-4 ml-auto">
          {user ? (
            <>
              ...
              >
                {open ? <X className="w-[clamp(16px,4vw,24px)] h-[clamp(16px,4vw,24px)]" /> : <Menu className="w-[clamp(16px,4vw,24px)] h-[clamp(16px,4vw,24px)]" />}
              </button>
            </>
          ) : (
            <>
              ...
              <div className="hidden md:flex items-center gap-4 text-[clamp(0.8rem,2vw,1rem)]">
                ...
                <Link
                  href="/signup"
                  className="bg-[var(--highlight)] text-[var(--accent-4)] px-4 sm:px-5 py-1 sm:py-2 rounded-md font-semibold hover:scale-105 transition"
                >
                  Sign Up
                </Link>
              </div>
