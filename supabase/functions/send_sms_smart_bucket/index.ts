...
const BATCH_WINDOWS = [
  { label: 'Midday',    startHour: 18, startMinute: 30, endHour: 19, endMinute: 30 },
  { label: 'Morning',   startHour: 18, startMinute: 0,  endHour: 19, endMinute: 0  },
...
const MONDAY_MORNING_START_HOUR   = 18
const MONDAY_MORNING_START_MINUTE = 30
const MONDAY_MORNING_END_HOUR     = 19
